...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    */
    ...
    /*
    div.card_container:first-child {
      background: blue;
    }
    */
    .card_container{
...
let cardCheckboxs1 = document.querySelectorAll("#label_group1 .label_icon input[name='selected_color']");
   ...
   openCardModel: (event)=> {
      ...
      let theCheckListsModelContainer = document.querySelector("#model_checklists_container");
      let cardCheckListsString = event.target.getAttribute("data-checklists");
      let checkListsModelContainer = document.querySelector("#model_checklists_container");
      ...
      checkListsModelContainer.innerHTML = "";
